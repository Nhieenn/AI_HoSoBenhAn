...
- `ai_engine/core/rag.py`: Module RAG mô phỏng.

### Module 8: Huấn luyện mô hình (Model Training Pipeline) (QC Pass: 2026-05-05)
- `ai_engine/core/training.py`: Module trích xuất dữ liệu và giả lập pipeline huấn luyện.
